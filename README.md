...
On a GPU, this took around 22 seconds to run on all 30 files. Per-file, this is 0.73 seconds a transcript.

On a CPU (with 4 cores), this took around 909 seconds to complete, or 15 minutes. Per-file, this is around 30 seconds a transcript.

This is still somewhat slow, but faster than you'd expect for a well-performing transformer-based model! More importantly, this is fast enough to reasonably on CPUs. Of course, longer transcipts will take longer, but should linearly scale.
